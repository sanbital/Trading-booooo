...
def regex_once(path: str, pattern: str, replacement: str, marker: str) -> None:
    ...
    if count != 1:
        raise SystemExit(f"{path}: regex source block not found: {pattern[:120]!r}")
    write(path, updated)
...
literal(ENTRY, "const DEFAULT_MAX_GAINER_RANK = 3;", "const DEFAULT_MAX_GAINER_RANK = 10;", "const DEFAULT_MAX_GAINER_RANK = 10;")
literal(GATE, "export const LOB_DEFAULT_MAX_GAINER_RANK = 3;", "export const LOB_DEFAULT_MAX_GAINER_RANK = 10;", "export const LOB_DEFAULT_MAX_GAINER_RANK = 10;")
...
literal(ENGINE, 'export const ENGINE_VERSION = "7.3.5-APPROVAL-SURVIVES-REQUOTE";', f'export const ENGINE_VERSION = "{VERSION}";', VERSION)
literal(AUTOTRADER, 'const VERSION = "7.3.5-APPROVAL-SURVIVES-REQUOTE";', f'const VERSION = "{VERSION}";', VERSION)
