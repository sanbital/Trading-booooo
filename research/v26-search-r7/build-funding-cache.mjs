...
async function fetchSymbol(symbol){
  ...
  url.searchParams.set("symbol",symbol);url.searchParams.set("startTime",String(START));url.searchParams.set("endTime",String(END));url.searchParams.set("limit","1000");
  let last;
...
const coverage=[];for(const symbol of symbols)coverage.push(reusable.get(symbol)||await fetchSymbol(symbol));
