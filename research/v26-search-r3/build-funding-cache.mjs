...
const seed=JSON.parse(readFileSync(process.env.SEED_FUNDING_CACHE,"utf8"));
...
const coverage=[];
for(const symbol of symbols)coverage.push(reusable.get(symbol)||await fetchSymbol(symbol));
