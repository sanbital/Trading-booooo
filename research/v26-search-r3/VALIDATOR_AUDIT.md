...
- Integrity and candidate regression suite: 24/24 pass.
- Binance Vision checksum, cache-stable content hashing, cutoff coverage and per-month fallback remained active.
- The first replay attempt failed closed on one symbol missing from the prior funding cache; no summary from that attempt was produced or evaluated.
