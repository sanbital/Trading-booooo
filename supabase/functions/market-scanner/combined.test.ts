...
function candidate(
  ...
  return {
    ...
    trade_plan: {
      ...
      assumed_order_notional_quote: 100_000,
      estimated_round_trip_cost_pct: 0.2,
      structural_headroom_net_pct: 2.8,
      estimated_entry_slippage_bps: 2,
      short_target: 103,
      short_target_execution_estimate: 102.9,
      medium_target: 106,
      medium_target_execution_estimate: 105.9,
      target_strategy: "SHORT_ONLY",
      target_strategy_label: "단기 목표 일괄청산",
      first_target_allocation_pct: 100,
      continuation_allocation_pct: 0,
    ...
    execution_plan: {
      ...
      intended_holding_hours: 48,
      next_review_after_hours: 8,
      max_holding_hours: 72,
      monitoring_requirement: decision === "BUY" ? "PRECOMMITTED_EXIT" : "RECHECK_REQUIRED",
      buy_instruction: "test",
      exit_instruction: "test",
      stale_instruction: "test",
    },
    forecast: {
      model_version: "test",
      ...
      target_hit_probability_pct: 55,
      wait_entry_probability_pct: watchAvailable ? 40 : null,
      raw_expected_upside_pct: 2.5,
      expected_upside_pct: 2,
      conservative_upside_pct: 1.2,
      optimistic_upside_pct: 4,
      expected_price: 102,
      conservative_price: 101.2,
      optimistic_price: 104,
      expected_net_return_pct: 2,
      confidence_band_pct: 1.4,
      horizon_bars_15m: 192,
      horizon_label: "1~3일",
      drivers: [],
      caveats: [],
    },
