...
import {nextExitReviewed, EXIT_REVIEW_CANDIDATE, exitAttemptId, classifyExitResponse} from "../_shared/leader-exit-review.mjs";
import {createGatewayProtection} from "../_shared/leader-protection-adapter.mjs";
const REVISION="V11-LONG-REGIME-1.0.1",PATCH="V17-EXIT-RELIABILITY-REVIEW-2",OBSERVER_REVISION="MARKET-REGIME-OBSERVER-v2-C01-HYSTERESIS-v1-FULLMARKET",PROTOCOL="8.0.0-P10-DONCHIAN-SLOW4R";
...
async function openBull(db,s,openPositions,manual=null){
...
async function manageLeader(db,p,ctx){
  ...
  return {action:"HOLD",strategy:STRATEGY,bid,...state};
}
