...
export const TERMINAL_RULES=Object.freeze([
  ...
  [C.SLOT_UNAVAILABLE,'^(SLOT_UNAVAILABLE|V11_SLOT_FULL|DUPLICATE_SYMBOL_OPEN|PORTFOLIO_CHANGED|V17_SETUP_POLICY_SLOT_LIMIT|ENTRY_MARGIN_INSUFFICIENT|EXECUTION_SAFETY_REJECT:INSUFFICIENT_MARGIN)'],
