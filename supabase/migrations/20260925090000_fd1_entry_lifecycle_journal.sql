...
returns text language sql immutable set search_path=pg_catalog as $$
  select case
    ...
    when p_reason ~ '^(SLOT_UNAVAILABLE|V11_SLOT_FULL|DUPLICATE_SYMBOL_OPEN|PORTFOLIO_CHANGED|V17_SETUP_POLICY_SLOT_LIMIT|ENTRY_MARGIN_INSUFFICIENT|EXECUTION_SAFETY_REJECT:INSUFFICIENT_MARGIN)' then 'SLOT_UNAVAILABLE'
