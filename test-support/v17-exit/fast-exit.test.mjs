...
import {nextExitReviewed} from '../../supabase/functions/_shared/leader-exit-review.mjs';
...
const make=(stale=false)=>{
 ...
 const ctx={Date,Number,Array,Error,POLICY,nextExitReviewed,console,rec:x=>x??{},STRATEGY:'LEADER_MOMENTUM_V17',
