import * as authority from '../supabase/functions/_shared/exit-authority.mjs';
...
export const managerBindings={...authority,...cec,...fd1,FD1_TIME_REASONS:fd1.TIME_REASONS};
